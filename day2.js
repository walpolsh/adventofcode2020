...
1-3 b: cdefg
2-9 c: ccccccccc`;
let input2 = `4-8 n: dnjjrtclnzdnghnbnn
5-6 r: rrrrcqr
2-4 p: pqhpppwpfmr
...
const day2part1 = (array) => {
  let valid = 0;
  for (let i = 0; i < array.length; i++) {
    const [low, high] = array[i][0].split("-");
    const letter = array[i][1].replace(":", "");
    const string = array[i][2];
    let count = 0;
...
// console.log(day2part1(splitString(input1)));
// console.log(day2part1(splitString(input2)));

const day2part2 = (array) => {
  let valid = 0;
  for (let i = 0; i < array.length; i++) {
    const [low, high] = array[i][0].split("-");
    const letter = array[i][1].replace(":", "");
    const string = array[i][2];
    if (
      (string[low - 1] === letter && string[high - 1] === letter) ||
      (string[low - 1] !== letter && string[high - 1] !== letter)
    ) {
      continue;
    } else {
...
console.log(day2part2(splitString(input1)));
console.log(day2part2(splitString(input2)));
